...
#| lst-cap: "I samme mutate lager vi også variabelen edu_fac ved å kutte education opp i fire intervaller"
#| echo: true
#| eval: false
...
#| lst-cap: "Endrer rekkefølgen på variablene s.a. kategorivariablene samles lengst til høyre i datasettet."
#| echo: true
#| eval: false
select(income:age, education:bmi, everything())
```
...
#| lst-cap: "Vi skal ikke benytte variablene `marital` og `education` så disse droppes fra datasettet."
#| echo: true
#| eval: false
select(-education, -marital)
```
...
#| lst-cap: "Vi deler `hoyde` inn i tre «subsets». Datasettet `hoydeNormInc` er det vi vil konsentrere oss om."
#| echo: true
# Inntekt lik 0
heightsZeroInc <- heights |> 
  filter(income == 0)
