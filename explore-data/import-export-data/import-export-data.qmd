...
-   I think we have covered most of this already
-   A quick skim of the chapter is recommended.
-   One noteworthy point is "fast printing"
...
```{r fast-printing}
#| code-fold: true
# Fast, to assign and print on one line enclose 
# in parentheses
(x <- c(1, 2, 3))
```
...
-   This menu selection uses the @R-readr.
