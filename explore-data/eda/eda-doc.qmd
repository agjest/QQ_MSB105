...
General reflection up on the concept of *Exploratory Data Analysis*.
You will find details and more code in [chapter 7 of r4ds](https://r4ds.had.co.nz/exploratory-data-analysis.html).
...
-   What to do? cont.
    -   In some rare cases it might be acceptable to edit the data
        ...
        -   Ex.
            percentage unemployed timeseries: 2,3%, 3,7% ... 270% ... 4,1%.
