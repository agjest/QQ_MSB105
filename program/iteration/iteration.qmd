...
-   For loops, used to be quite slow in R, but not any more
    ...
    -   Often there is cleaner R way if one can just recognise it
...
-   We will use the *tidyvers'* reimplementation of the apply family
...
-   Building dataframe.
    ...
    -   Instead put intermediate results into a_list.
...
-   a tibble/dataframe is a **list** of equal length vectors. The
    ...
    elements, i.e. the number of vectors in df which is also det number
    of columns.
