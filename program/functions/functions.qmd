...
-   If variable is not defined R will look outside function (the
    ...
    -   Most programming languages would give an error
...
-   Add an argument to select how many digits should be printed
-   Use the `round(digits = )` function to do the job
-   Add argument to select output as a nice flextable
