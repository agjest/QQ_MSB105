...
-   `\w`: matches word character (Alphanumeric characters, ex.
    "sd34fgg2K")
...
-   Hamsun mentions some form of *sult* (hunger) 48 times in his novel.
...
```{r}
# the first 6 occurrences 
str_locate_all(sult, ss) |>  
  # a list in pipe
  pluck(1) |> 
  head()
```
